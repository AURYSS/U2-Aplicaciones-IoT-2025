...
MQTT_TOPIC = "sensores/analogico"
MQTT_PORT = 1883

# Configuración del sensor analógico
SENSOR_PIN = 34  # Pin GPIO para la señal del sensor
...
while True:
    try:
        # Leer el valor de la señal del sensor
        sensor_value = sensor.read()

        # Crear el mensaje con el valor de la señal
        mensaje = {
            "sensor": "analogico",
            "valor": sensor_value
