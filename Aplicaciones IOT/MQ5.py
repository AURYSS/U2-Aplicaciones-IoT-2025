...
MQTT_USER = ""
MQTT_PASSWORD = ""
MQTT_CLIENT_ID = "esp32_sensor_mq4"
MQTT_TOPIC = "sensores/mq4"  # Tópico para el sensor MQ-4
MQTT_PORT = 1883

# Configuración del pin del sensor MQ-4
SENSOR_DIGITAL_PIN = 13  # Pin GPIO para el sensor MQ-4 (conectado al DO)
SENSOR_ANALOG_PIN = 34   # Pin ADC para el sensor MQ-4 (conectado al AO)
