...
MQTT_USER = ""
MQTT_PASSWORD = ""
MQTT_CLIENT_ID = "ky026_client"
MQTT_TOPIC = "sensores/flama"
MQTT_PORT = 1883

# Configuración de pines
sensor_ao = ADC(Pin(34))  # Pin ADC para la salida analógica (AO)
sensor_do = Pin(12, Pin.IN)  # Pin digital para la salida digital (DO)
...
while True:
    try:
        ...
        # Publicar en MQTT
        mensaje = f"Flama detectada - AO: {valor_analogico}, DO: {'Sí' if valor_digital == 0 else 'No'}"
        print(mensaje)
