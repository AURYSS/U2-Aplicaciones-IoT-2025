...
MQTT_TOPIC = "sensores/sonido"  # Tópico para el sensor de sonido
MQTT_PORT = 1883

# Configuración del pin del sensor KY-038
SENSOR_DIGITAL_PIN = 13  # Pin GPIO para el sensor KY-038 (conectado al DO)
SENSOR_ANALOG_PIN = 34   # Pin ADC para el sensor KY-038 (conectado al AO)
...
while True:
    try:
        ...
        mensaje = {
            "sensor": "sonido",
            "estado_digital": "nivel_alto" if estado_digital == 0 else "nivel_bajo",
